...
\begin{equation*}
S=\frac{F1_{Train} + F1_{Train}}{2(1+(F1_{Train} + F1_{Train}))}  ,     {0<= S <= 1}
\end{equation*}
...
\begin{equation*}
AUSC=\frac{0.5}{3}\left[y_0+y_n+4*\sum \left(y_1,y_3...y_n-1\right)+2*\sum \left(y_2,y_4...y_n-2\right)\right], 0<=AUSC<=10
\end{equation*}
